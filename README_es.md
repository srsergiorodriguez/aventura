...
## Ejemplos
* Un ejemplo de un generador de poemas: [Demostración](https://srsergiorodriguez.github.io/autopoeta/){:target="_blank"} / [Gramática](https://github.com/srsergiorodriguez/autopoeta/blob/master/docs/assets/autopoetadb.json){:target="_blank"}

* Un ejemplo de una historia interactiva basada en una historia de Sherlock Holmes: [Demostración](https://srsergiorodriguez.github.io/aventura/ejemplos/historia_interactiva/){:target="_blank"} / [Código](https://github.com/srsergiorodriguez/aventura/blob/master/docs/ejemplos/historia_interactiva/main.js){:target="_blank"}
